...
- **Explainable AI (XAI)**: Results are paired with SHAP bar charts that visualize *why* the model made its prediction, showing the key features that influenced the outcome.
